...
<div class="sc-app" data-shakass-customizer>
    <header class="sc-topbar">
        <div class="sc-brand"><span class="sc-brand-mark">S</span><span>Shakass Communication</span></div>
        <nav class="sc-breadcrumb">Mes projets <span>›</span> Collection Été 2025 <span>›</span> <strong>T-shirt Streetwear</strong></nav>
        <div class="sc-actions"><button data-action="undo">Annuler</button><button data-action="redo">Rétablir</button><button data-action="save" class="sc-soft">Enregistrer</button><button data-action="reset">Réinitialiser</button></div>
    </header>
    ...
    <main class="sc-workspace">
        ...
        <section class="sc-stage"><div class="sc-face-switch"><button class="is-active" data-side="front">Face</button><button data-side="back">Dos</button></div><div class="sc-shirt" data-shirt-mockup><div class="sc-shirt-neck"></div><div class="sc-print-zone"><canvas id="shakass-canvas" width="360" height="430"></canvas></div></div><div class="sc-zoom"><button data-zoom="out">−</button><span data-zoom-label>100%</span><button data-zoom="in">+</button></div></section>

        <aside class="sc-summary"><h2>Récapitulatif</h2><dl><dt>Produit</dt><dd data-summary-product>T-shirt</dd><dt>Couleur</dt><dd data-summary-color>Noir premium</dd><dt>Taille</dt><dd data-summary-size>M</dd><dt>Quantité</dt><dd data-summary-quantity>25</dd><dt>Technique</dt><dd>Impression textile premium</dd><dt>Prix estimatif HT</dt><dd class="sc-price">Sur devis</dd></dl><button class="sc-primary" data-open-request>Envoyer ma demande</button><div class="sc-secondary-layers"><h3>Calques</h3><div data-layers-secondary></div></div></aside>
    </main>
